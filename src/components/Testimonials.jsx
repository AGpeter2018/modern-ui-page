...
const Testimonials = () => {
  ...
  <p className="text-gray-500 text-xl text-base sm:text-lg max-w-2xl mx-auto">
    Everything you need to build, debug, test, and deploy application with AI powered develoment tools.
  </p> 
</div>
<div className='lg:w-1/2 w-full'>
<div className='space-y-6 sm:space-y-8'>
  {testimonials.map((testimonial, key) => {
    return <div key={key} className='bg-slate-900/50 p-4 sm:p-6 backdrop-blur-sm border border-slate-800 rounded-xl sm:rounded-2xl'>
      <div className='flex items-center space-x-3 sm:space-x-4'>
        <div className='flex-shrink-0'>
          <div className='text-2xl sm:text-3xl lg:text-4xl font-bold bg-gradient-to-r from-blue-400 t0-cyan-400 bg-clip-text text-transparent'>"</div>
        </div>
      </div>
