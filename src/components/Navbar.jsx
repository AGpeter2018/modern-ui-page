    ...
    <path d="M 5 -20 L 20 0 L 5 20" 
          ...
          stroke-linejoin="round"/>
                ...
                <div className='hidden md:flex items-center space-x-6 lg:space-8'>
                    ...
                    <a href="#testimonials" className={`text-gray-300 hover:text-white text-sm lg:text-base ${markTab === 'testimonies' ? ('border-b border-blue-900 p-5 '):('')}`} onClick={() => setMarkTab('testimonies')}>Testimonials</a>
                </div>
